...
var budgetsSlice = (0, _toolkit.createSlice)({
  ...
  reducers: {
    editBudget: function editBudget(state, action) {
      ...
      var newBudget = state.find(function (budget) {
...
var transactionSlice = (0, _toolkit.createSlice)({
  name: 'transactions',
  initialState: initialState,
  reducers: {
    ...
    deleteTransaction: function deleteTransaction(state, action) {
      ...
      state[category] = state[category].filter(function (obj) {
        return obj.id !== id;
      });
    }
  }
...
var _transactionSlice$act = transactionSlice.actions,
  ...
  deleteTransaction = _transactionSlice$act.deleteTransaction;
exports.deleteTransaction = deleteTransaction;
exports.addTransaction = addTransaction;
var _default = transactionSlice.reducer;
exports["default"] = _default;
